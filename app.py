...
def make_listing():
     ...
     new_listing = Listing(
           ...
           make_id = int(form_data[0]),
           model_id = int(form_data[1]),
           title = form_data[2] if form_data[2] else None,
           price = currency_convert,
           configuration = form_data[4] if form_data[4] else None,
           drivetrain = form_data[5] if form_data[5] else None,
           fuel_type = form_data[6] if form_data[6] else None,
           transmission = form_data[7] if form_data[7] else None,
           description = form_data[8] if form_data[8] else None,
           ...
           colour = form_data[14] if form_data[14] else None,
           body_style = form_data[15] if form_data[15] else None,
           status = form_data[16]
      )
